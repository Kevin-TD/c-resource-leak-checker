...
bool GetPredecessorsTester::runTest() {
    ...
    instructionNumToExpectedNumberOfPredsMap[3] = 1;
    instructionNumToExpectedNumberOfPredsMap[4] = 1;
    instructionNumToExpectedNumberOfPredsMap[5] = 1;
    instructionNumToExpectedNumberOfPredsMap[6] = 1;
    instructionNumToExpectedNumberOfPredsMap[7] = 1;
    instructionNumToExpectedNumberOfPredsMap[8] = 1;
    instructionNumToExpectedNumberOfPredsMap[9] = 1;
    instructionNumToExpectedNumberOfPredsMap[10] = 1;
    instructionNumToExpectedNumberOfPredsMap[11] = 1;
    instructionNumToExpectedNumberOfPredsMap[12] = 1;
    instructionNumToExpectedNumberOfPredsMap[13] = 1;
    instructionNumToExpectedNumberOfPredsMap[14] = 1;
    instructionNumToExpectedNumberOfPredsMap[15] = 1;
    instructionNumToExpectedNumberOfPredsMap[16] = 2;
    instructionNumToExpectedNumberOfPredsMap[17] = 1;
    ...
    for (auto &F : *parsedModule) {
        for (auto &BB : F) {
            for (auto &instruction : BB) {
                bool expectedEqResult = instructionNumToExpectedNumberOfPredsMap[instructionNumber] ==  rlc_dataflow::getPredecessors(&instruction).size();
                if (!expectedEqResult) {
                    return false;
                }
                instructionNumber++;
