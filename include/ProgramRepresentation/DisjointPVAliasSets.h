...
class DisjointPVAliasSets {
  ...
  public:
    ...
    bool unionSets(ProgramVariable elementA, ProgramVariable elementB);
    ...
    bool addAlias(ProgramVariable element1, ProgramVariable element2, ProgramFunction *pf);
