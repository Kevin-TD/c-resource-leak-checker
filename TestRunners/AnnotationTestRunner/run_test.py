...
if __name__ == "__main__":
    ...
    flag_managers = FlagsManager("python3 ../run_at.py [required test folder name] [optional flags]")
    ...
    flag_managers.add_flag(
        ...
        lambda annotation_test_files_manager, file_name: annotation_test_files_manager.get_file(file_name).toggle_test_running()   
    )
    ...
    flag_managers.add_flag(
        ...
        lambda annotation_test_files_manager, file_name : [file.toggle_test_running() for file in annotation_test_files_manager.get_all_files_excluding(file_name)]
    )
    ...
    for c_file in c_files:
        ...
        f = annotation_test_files_manager.get_file(c_file[find_nth(c_file, "/", 3) + 1:])
        ...
        if f.test_will_run():
            test_text_file = "../Testers/Annotations/" + test_folder_name + "/" + f.get_file_name().replace(".c", ".txt")
