...
entry:
  ...
  %cmp = icmp eq i32 %7, -15, !dbg !92
  br i1 %cmp, label %if.then, label %if.else10, !dbg !93

if.then:                                          ; preds = %entry
  %8 = load i8*, i8** %str, align 8, !dbg !94
  call void @free0(i8* %8), !dbg !96
  %9 = load i8*, i8** %str, align 8, !dbg !97
  call void @free(i8* %9) #4, !dbg !98
  call void @llvm.dbg.declare(metadata i8** %m, metadata !99, metadata !DIExpression()), !dbg !100
  %call7 = call noalias i8* @malloc(i64 15) #4, !dbg !101
  store i8* %call7, i8** %m, align 8, !dbg !102
  %10 = load i8*, i8** %m, align 8, !dbg !103
  call void @free(i8* %10) #4, !dbg !104
  %11 = load i32, i32* %a, align 4, !dbg !105
  %cmp8 = icmp eq i32 %11, -200, !dbg !107
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !108

if.then9:                                         ; preds = %if.then
  %12 = load i8*, i8** %m, align 8, !dbg !109
  call void @free0(i8* %12), !dbg !111
  br label %if.end, !dbg !112

if.else:                                          ; preds = %if.then
  %13 = load i8*, i8** %m, align 8, !dbg !113
  call void @free0(i8* %13), !dbg !115
  br label %if.end
...
if.else10:                                        ; preds = %entry
  %14 = load i8*, i8** %str, align 8, !dbg !117
  call void @free(i8* %14) #4, !dbg !119
  br label %if.end11
...
!1 = !DIFile(filename: "../test/test14.c", directory: "/c-resource-leak-checker/build")
!2 = !{}
!3 = !{!4}
...
!91 = distinct !DILexicalBlock(scope: !66, file: !1, line: 49, column: 9)
!92 = !DILocation(line: 49, column: 11, scope: !91)
!93 = !DILocation(line: 49, column: 9, scope: !66)
!94 = !DILocation(line: 50, column: 15, scope: !95)
!95 = distinct !DILexicalBlock(scope: !91, file: !1, line: 49, column: 19)
!96 = !DILocation(line: 50, column: 9, scope: !95)
!97 = !DILocation(line: 51, column: 14, scope: !95)
!98 = !DILocation(line: 51, column: 9, scope: !95)
!99 = !DILocalVariable(name: "m", scope: !95, file: !1, line: 52, type: !4)
!100 = !DILocation(line: 52, column: 15, scope: !95)
!101 = !DILocation(line: 53, column: 20, scope: !95)
!102 = !DILocation(line: 53, column: 11, scope: !95)
!103 = !DILocation(line: 54, column: 14, scope: !95)
!104 = !DILocation(line: 54, column: 9, scope: !95)
!105 = !DILocation(line: 55, column: 13, scope: !106)
!106 = distinct !DILexicalBlock(scope: !95, file: !1, line: 55, column: 13)
!107 = !DILocation(line: 55, column: 15, scope: !106)
!108 = !DILocation(line: 55, column: 13, scope: !95)
!109 = !DILocation(line: 56, column: 19, scope: !110)
!110 = distinct !DILexicalBlock(scope: !106, file: !1, line: 55, column: 24)
!111 = !DILocation(line: 56, column: 13, scope: !110)
!112 = !DILocation(line: 57, column: 9, scope: !110)
!113 = !DILocation(line: 59, column: 19, scope: !114)
!114 = distinct !DILexicalBlock(scope: !106, file: !1, line: 58, column: 14)
!115 = !DILocation(line: 59, column: 13, scope: !114)
!116 = !DILocation(line: 61, column: 5, scope: !95)
!117 = !DILocation(line: 63, column: 14, scope: !118)
!118 = distinct !DILexicalBlock(scope: !91, file: !1, line: 62, column: 10)
!119 = !DILocation(line: 63, column: 9, scope: !118)
!120 = !DILocation(line: 66, column: 4, scope: !66)
