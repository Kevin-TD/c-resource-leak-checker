; ModuleID = '../test/nesting_test/call_structs.c'
source_filename = "../test/nesting_test/call_structs.c"
...
@.str.1 = private unnamed_addr constant [36 x i8] c"../test/nesting_test/call_structs.c\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %s.addr1, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.1, i32 0, i32 0), i32 28)
...
entry:
  ...
  %s.addr1 = bitcast i8** %s.addr to i8*
  call void @llvm.var.annotation(i8* %s.addr1, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.1, i32 0, i32 0), i32 32)
  ...
  call void @llvm.var.annotation(i8* %X2, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.1, i32 0, i32 0), i32 32)
  ...
  %5 = call i8* @llvm.ptr.annotation.p0i8(i8* %4, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i32 7), !dbg !33
...
entry:
  ...
  call void @llvm.var.annotation(i8* %S1, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.1, i32 0, i32 0), i32 39)
  %x = getelementptr inbounds %struct.my_struct, %struct.my_struct* %S, i32 0, i32 0, !dbg !45
  %3 = bitcast i8** %x to i8*, !dbg !45
  %4 = call i8* @llvm.ptr.annotation.p0i8(i8* %3, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i32 7), !dbg !45
...
entry:
  ...
  %1 = call i8* @llvm.ptr.annotation.p0i8(i8* %0, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i32 7), !dbg !69
  ...
  %4 = call i8* @llvm.ptr.annotation.p0i8(i8* %3, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i32 8), !dbg !72
  ...
  %7 = call i8* @llvm.ptr.annotation.p0i8(i8* %6, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i32 13), !dbg !75
  ...
  %10 = call i8* @llvm.ptr.annotation.p0i8(i8* %9, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i32 17), !dbg !78
  ...
  %20 = call i8* @llvm.ptr.annotation.p0i8(i8* %19, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i32 8), !dbg !89
  ...
  %24 = call i8* @llvm.ptr.annotation.p0i8(i8* %23, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i32 13), !dbg !91
  ...
  %28 = call i8* @llvm.ptr.annotation.p0i8(i8* %27, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i32 17), !dbg !93
...
!1 = !DIFile(filename: "../test/nesting_test/call_structs.c", directory: "/c-resource-leak-checker/build")
!2 = !{}
!3 = !{!4}
...
!10 = distinct !DISubprogram(name: "does_free", scope: !1, file: !1, line: 28, type: !11, scopeLine: 28, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!11 = !DISubroutineType(types: !12)
!12 = !{null, !4}
!13 = !DILocalVariable(name: "s", arg: 1, scope: !10, file: !1, line: 28, type: !4)
!14 = !DILocation(line: 28, column: 22, scope: !10)
!15 = !DILocation(line: 29, column: 10, scope: !10)
!16 = !DILocation(line: 29, column: 5, scope: !10)
!17 = !DILocation(line: 30, column: 1, scope: !10)
!18 = distinct !DISubprogram(name: "creates_obligation", scope: !1, file: !1, line: 32, type: !19, scopeLine: 32, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!19 = !DISubroutineType(types: !20)
!20 = !{!4, !4, !21}
!21 = !DIDerivedType(tag: DW_TAG_typedef, name: "my_struct", file: !22, line: 9, baseType: !23)
!22 = !DIFile(filename: "../test/nesting_test/call_structs.h", directory: "/c-resource-leak-checker/build")
...
!27 = !DILocalVariable(name: "s", arg: 1, scope: !18, file: !1, line: 32, type: !4)
!28 = !DILocation(line: 32, column: 49, scope: !18)
!29 = !DILocalVariable(name: "X", arg: 2, scope: !18, file: !1, line: 32, type: !21)
!30 = !DILocation(line: 32, column: 76, scope: !18)
!31 = !DILocation(line: 33, column: 10, scope: !18)
!32 = !DILocation(line: 33, column: 5, scope: !18)
!33 = !DILocation(line: 34, column: 12, scope: !18)
!34 = !DILocation(line: 34, column: 5, scope: !18)
!35 = !DILocalVariable(name: "str", scope: !18, file: !1, line: 35, type: !4)
!36 = !DILocation(line: 35, column: 11, scope: !18)
!37 = !DILocation(line: 35, column: 24, scope: !18)
!38 = !DILocation(line: 36, column: 12, scope: !18)
!39 = !DILocation(line: 36, column: 5, scope: !18)
!40 = distinct !DISubprogram(name: "does_something", scope: !1, file: !1, line: 39, type: !41, scopeLine: 39, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!41 = !DISubroutineType(types: !42)
!42 = !{!23, !21}
!43 = !DILocalVariable(name: "S", arg: 1, scope: !40, file: !1, line: 39, type: !21)
!44 = !DILocation(line: 39, column: 55, scope: !40)
!45 = !DILocation(line: 40, column: 12, scope: !40)
!46 = !DILocation(line: 40, column: 5, scope: !40)
!47 = !DILocation(line: 41, column: 12, scope: !40)
!48 = !DILocation(line: 41, column: 5, scope: !40)
!49 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 44, type: !50, scopeLine: 44, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!50 = !DISubroutineType(types: !51)
!51 = !{!52}
!52 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!53 = !DILocalVariable(name: "k", scope: !49, file: !1, line: 49, type: !23)
!54 = !DILocation(line: 49, column: 22, scope: !49)
!55 = !DILocalVariable(name: "m", scope: !49, file: !1, line: 50, type: !56)
...
!61 = !DILocation(line: 50, column: 17, scope: !49)
!62 = !DILocalVariable(name: "km", scope: !49, file: !1, line: 51, type: !63)
...
!67 = !DILocation(line: 51, column: 24, scope: !49)
!68 = !DILocation(line: 53, column: 18, scope: !49)
!69 = !DILocation(line: 53, column: 7, scope: !49)
!70 = !DILocation(line: 53, column: 9, scope: !49)
!71 = !DILocation(line: 54, column: 18, scope: !49)
!72 = !DILocation(line: 54, column: 7, scope: !49)
!73 = !DILocation(line: 54, column: 9, scope: !49)
!74 = !DILocation(line: 57, column: 18, scope: !49)
!75 = !DILocation(line: 57, column: 7, scope: !49)
!76 = !DILocation(line: 57, column: 9, scope: !49)
!77 = !DILocation(line: 58, column: 19, scope: !49)
!78 = !DILocation(line: 58, column: 8, scope: !49)
!79 = !DILocation(line: 58, column: 10, scope: !49)
!80 = !DILocalVariable(name: "s", scope: !49, file: !1, line: 60, type: !4)
!81 = !DILocation(line: 60, column: 11, scope: !49)
!82 = !DILocation(line: 60, column: 22, scope: !49)
!83 = !DILocalVariable(name: "y", scope: !49, file: !1, line: 61, type: !4)
!84 = !DILocation(line: 61, column: 11, scope: !49)
!85 = !DILocation(line: 61, column: 34, scope: !49)
!86 = !DILocation(line: 61, column: 15, scope: !49)
!87 = !DILocation(line: 63, column: 10, scope: !49)
!88 = !DILocation(line: 63, column: 5, scope: !49)
!89 = !DILocation(line: 64, column: 17, scope: !49)
!90 = !DILocation(line: 64, column: 5, scope: !49)
!91 = !DILocation(line: 66, column: 17, scope: !49)
!92 = !DILocation(line: 66, column: 5, scope: !49)
!93 = !DILocation(line: 67, column: 18, scope: !49)
!94 = !DILocation(line: 67, column: 5, scope: !49)
!95 = !DILocation(line: 71, column: 1, scope: !49)
