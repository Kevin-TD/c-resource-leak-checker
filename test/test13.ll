...
if.then:                                          ; preds = %entry
  ...
  call void @llvm.dbg.declare(metadata i8** %s, metadata !41, metadata !DIExpression()), !dbg !42
  %call7 = call noalias i8* @malloc(i64 15) #4, !dbg !43
  store i8* %call7, i8** %s, align 8, !dbg !44
  %9 = load i8*, i8** %s, align 8, !dbg !45
  call void @free(i8* %9) #4, !dbg !46
  br label %if.end, !dbg !47

if.end:                                           ; preds = %if.then, %entry
  %10 = load i8*, i8** %str, align 8, !dbg !48
  call void @free(i8* %10) #4, !dbg !49
  ret i32 0, !dbg !50
}
...
!1 = !DIFile(filename: "../test/test13.c", directory: "/c-resource-leak-checker/build")
!2 = !{}
!3 = !{!4}
...
!35 = distinct !DILexicalBlock(scope: !10, file: !1, line: 18, column: 9)
!36 = !DILocation(line: 18, column: 11, scope: !35)
!37 = !DILocation(line: 18, column: 9, scope: !10)
!38 = !DILocation(line: 19, column: 15, scope: !39)
!39 = distinct !DILexicalBlock(scope: !35, file: !1, line: 18, column: 19)
!40 = !DILocation(line: 19, column: 10, scope: !39)
!41 = !DILocalVariable(name: "s", scope: !39, file: !1, line: 20, type: !4)
!42 = !DILocation(line: 20, column: 16, scope: !39)
!43 = !DILocation(line: 21, column: 21, scope: !39)
!44 = !DILocation(line: 21, column: 12, scope: !39)
!45 = !DILocation(line: 22, column: 15, scope: !39)
!46 = !DILocation(line: 22, column: 10, scope: !39)
!47 = !DILocation(line: 23, column: 5, scope: !39)
!48 = !DILocation(line: 25, column: 9, scope: !10)
!49 = !DILocation(line: 25, column: 4, scope: !10)
!50 = !DILocation(line: 26, column: 4, scope: !10)
