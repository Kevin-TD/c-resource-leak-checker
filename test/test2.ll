...
entry:
  ...
  %call1 = call i8* @strcpy(i8* %0, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0)) #4, !dbg !19
  ...
  %call4 = call i8* @strcat(i8* %4, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0)) #4, !dbg !27
...
!1 = !DIFile(filename: "../test/test2.c", directory: "/C-resource-leak-checker/build")
!2 = !{}
!3 = !{!4}
...
!16 = !DILocation(line: 9, column: 19, scope: !10)
!17 = !DILocation(line: 9, column: 8, scope: !10)
!18 = !DILocation(line: 10, column: 11, scope: !10)
!19 = !DILocation(line: 10, column: 4, scope: !10)
!20 = !DILocation(line: 11, column: 43, scope: !10)
!21 = !DILocation(line: 11, column: 48, scope: !10)
!22 = !DILocation(line: 11, column: 4, scope: !10)
!23 = !DILocation(line: 14, column: 27, scope: !10)
!24 = !DILocation(line: 14, column: 19, scope: !10)
!25 = !DILocation(line: 14, column: 8, scope: !10)
!26 = !DILocation(line: 15, column: 11, scope: !10)
!27 = !DILocation(line: 15, column: 4, scope: !10)
!28 = !DILocation(line: 16, column: 43, scope: !10)
!29 = !DILocation(line: 16, column: 48, scope: !10)
!30 = !DILocation(line: 16, column: 4, scope: !10)
!31 = !DILocation(line: 18, column: 9, scope: !10)
!32 = !DILocation(line: 18, column: 4, scope: !10)
!33 = !DILocation(line: 20, column: 4, scope: !10)
