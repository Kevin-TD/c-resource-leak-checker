; ModuleID = '../test/test9.c'
source_filename = "../test/test9.c"
...
entry:
  ...
  %8 = load i32, i32* %a, align 4, !dbg !48
  %cmp = icmp eq i32 %8, -15, !dbg !50
  br i1 %cmp, label %if.then, label %if.else, !dbg !51

if.then:                                          ; preds = %entry
  br label %if.end16, !dbg !52

if.else:                                          ; preds = %entry
  %9 = load i32, i32* %a, align 4, !dbg !54
  %cmp7 = icmp eq i32 %9, -10, !dbg !56
  br i1 %cmp7, label %if.then8, label %if.else14, !dbg !57
...
if.then8:                                         ; preds = %if.else
  ...
  br i1 %cmp10, label %if.then11, label %if.else12, !dbg !66
...
if.else12:                                        ; preds = %if.then8
  %12 = load i8*, i8** %str1, align 8, !dbg !71
  call void @free(i8* %12) #4, !dbg !73
  %13 = load i8*, i8** %str, align 8, !dbg !74
  %call13 = call i8* @realloc(i8* %13, i64 15) #4, !dbg !75
  br label %if.end
...
if.else14:                                        ; preds = %if.else
  %14 = load i8*, i8** %str, align 8, !dbg !77
  call void @free(i8* %14) #4, !dbg !79
  br label %if.end15
...
!1 = !DIFile(filename: "../test/test9.c", directory: "/C-resource-leak-checker/build")
!2 = !{}
!3 = !{!4}
...
!46 = !DILocation(line: 26, column: 9, scope: !22)
!47 = !DILocation(line: 26, column: 4, scope: !22)
!48 = !DILocation(line: 28, column: 9, scope: !49)
!49 = distinct !DILexicalBlock(scope: !22, file: !1, line: 28, column: 9)
!50 = !DILocation(line: 28, column: 11, scope: !49)
!51 = !DILocation(line: 28, column: 9, scope: !22)
!52 = !DILocation(line: 30, column: 5, scope: !53)
!53 = distinct !DILexicalBlock(scope: !49, file: !1, line: 28, column: 19)
!54 = !DILocation(line: 31, column: 14, scope: !55)
!55 = distinct !DILexicalBlock(scope: !49, file: !1, line: 31, column: 14)
!56 = !DILocation(line: 31, column: 16, scope: !55)
!57 = !DILocation(line: 31, column: 14, scope: !49)
!58 = !DILocalVariable(name: "str1", scope: !59, file: !1, line: 32, type: !4)
!59 = distinct !DILexicalBlock(scope: !55, file: !1, line: 31, column: 24)
!60 = !DILocation(line: 32, column: 15, scope: !59)
!61 = !DILocation(line: 33, column: 25, scope: !59)
!62 = !DILocation(line: 33, column: 14, scope: !59)
!63 = !DILocation(line: 35, column: 13, scope: !64)
!64 = distinct !DILexicalBlock(scope: !59, file: !1, line: 35, column: 13)
!65 = !DILocation(line: 35, column: 15, scope: !64)
!66 = !DILocation(line: 35, column: 13, scope: !59)
!67 = !DILocation(line: 36, column: 18, scope: !68)
!68 = distinct !DILexicalBlock(scope: !64, file: !1, line: 35, column: 22)
!69 = !DILocation(line: 36, column: 13, scope: !68)
!70 = !DILocation(line: 37, column: 9, scope: !68)
!71 = !DILocation(line: 38, column: 18, scope: !72)
!72 = distinct !DILexicalBlock(scope: !64, file: !1, line: 37, column: 16)
!73 = !DILocation(line: 38, column: 13, scope: !72)
!74 = !DILocation(line: 39, column: 21, scope: !72)
!75 = !DILocation(line: 39, column: 13, scope: !72)
!76 = !DILocation(line: 42, column: 5, scope: !59)
!77 = !DILocation(line: 44, column: 14, scope: !78)
!78 = distinct !DILexicalBlock(scope: !55, file: !1, line: 43, column: 10)
!79 = !DILocation(line: 44, column: 9, scope: !78)
!80 = !DILocation(line: 49, column: 4, scope: !22)
