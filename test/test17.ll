...
for.end:                                          ; preds = %for.cond
  %10 = load i32, i32* %a, align 4, !dbg !106
  %cmp7 = icmp slt i32 %10, 15, !dbg !108
  br i1 %cmp7, label %if.then, label %if.else, !dbg !109

if.then:                                          ; preds = %for.end
  %11 = load i8*, i8** %str, align 8, !dbg !110
  call void @free1(i8* %11), !dbg !112
  br label %if.end, !dbg !113

if.else:                                          ; preds = %for.end
  %12 = load i8*, i8** %str, align 8, !dbg !114
  call void @free1(i8* %12), !dbg !116
  br label %if.end
...
!107 = distinct !DILexicalBlock(scope: !66, file: !1, line: 55, column: 9)
!108 = !DILocation(line: 55, column: 11, scope: !107)
!109 = !DILocation(line: 55, column: 9, scope: !66)
!110 = !DILocation(line: 56, column: 15, scope: !111)
!111 = distinct !DILexicalBlock(scope: !107, file: !1, line: 55, column: 17)
!112 = !DILocation(line: 56, column: 9, scope: !111)
!113 = !DILocation(line: 57, column: 5, scope: !111)
!114 = !DILocation(line: 59, column: 15, scope: !115)
!115 = distinct !DILexicalBlock(scope: !107, file: !1, line: 58, column: 10)
!116 = !DILocation(line: 59, column: 9, scope: !115)
!117 = !DILocation(line: 62, column: 4, scope: !66)
